...
- Fixture counting: Prefer count_page_items. When its output includes countReliability or legendTypeCodes, treat those as authoritative for per-type tables. If reliability is not "high", report the verificationNotes and do not invent per-label counts from OCR/search_document alone.
